...
class PlayerCombatTest {
    ...
    void setUp() {
        ...
        attacker1 = new PlayerNinja("Shadow Assassin", NinjaClass.ASSASSIN, 80, 100, 20, 100, null,
                              new PlayerWeapon(new Weapon("Dagger", WeaponType.TANTO, 30, null, null)));
        attacker2 = new PlayerNinja("Silent Marksman", NinjaClass.MARKSMAN, 70, 90, 15, 90, null,
                              new PlayerWeapon(new Weapon("Bow", WeaponType.LONGBOW, 40, null, null)));
        attacker3 = new PlayerNinja("Fierce Samurai", NinjaClass.SAMURAI, 100, 110, 25, 110, null,
                              new PlayerWeapon(new Weapon("Katana", WeaponType.KATANA, 50, null, null)));

        // Initialize player team
        PlayerNinja[] playerNinjas = {attacker1, attacker2, attacker3};
        playerCombat = new PlayerCombat(player, playerNinjas);

        // Create defending ninjas
        defender1 = new PlayerNinja("Rival Assassin", NinjaClass.ASSASSIN, 75, 100, 20, 100, null, null);
        defender2 = new PlayerNinja("Rival Marksman", NinjaClass.MARKSMAN, 65, 85, 15, 90, null, null);
        defender3 = new PlayerNinja("Rival Samurai", NinjaClass.SAMURAI, 95, 105, 25, 110, null, null);

        // Initialize enemy team
        PlayerNinja[] enemyNinjas = {defender1, defender2, defender3};
